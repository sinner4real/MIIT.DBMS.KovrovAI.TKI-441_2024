...
/*
*@brief функци€ дл€ вставки новых корней дерева
*/
...
/*
*@brief функци€ дл€ удалени€ корн€ дерева
*/
void redblack::delete_value(int value)
{
    ...
    if (!is_leaf(nodeToDelete->left) && !is_leaf(nodeToDelete->right)) {
        // ЌайдЄм минимальный узел в правом поддереве (in-order successor)
        ...
        nodeToDelete = successor; // ”дал€ем преемника
    }
...
/*
*@brief функци€ дл€ поиска деда корн€ (корень->parent->parent)
...
/*
*@brief поиск д€ди корн€ (брат отца)
...
/*
*@brief вспомогательна€ функци€ дл€ удалени€ дерева
*/
...
/*
*@brief балансировка дерева после добавлени€ нового узла случай 1 (теори€ дл€ этого вз€та из википедии)
*/
void redblack::insert_case1(Node* n) {
    if (n->parent == nullptr) {
        n->color = 1; //  орень всегда черный
        root = n;
    }
    else {
        insert_case2(n);
...
/*
*@brief балансировка дерева после добавлени€ нового узла случай 2 (теори€ дл€ этого вз€та из википедии)
*/
void redblack::insert_case2(Node* n) {
    if (n->parent->color == 1) return; // ƒерево корректно
    insert_case3(n);
}

/*
*@brief балансировка дерева после добавлени€ нового узла случай 3 (теори€ дл€ этого вз€та из википедии)
*/
...
/*
*@brief балансировка дерева после добавлени€ нового узла случай 4 (теори€ дл€ этого вз€та из википедии)
*/
...
/*
*@brief балансировка дерева после добавлени€ нового узла случай 5 (теори€ дл€ этого вз€та из википедии)
*/
...
/*
*@brief вспомогательна€ функци€ дл€ красивого вывода целого дерева
*/
...
/*
*@brief функци€ дл€ поиска брата узла
...
/*
*@brief  онструктор с инициализатором списка 
*/
...
/*
*@brief ¬спомогательна€ функци€ дл€ копировани€ дерева
*/
...
/*
*@brief ¬спомогательна€ функци€ дл€ подсчета узлов дерева
*/
...
/*
*@brief  онструктор перемещени€
*/
redblack::redblack(redblack&& other) noexcept : root(other.root) {
    other.root = nullptr; // »сходное дерево тер€ет владение
}
